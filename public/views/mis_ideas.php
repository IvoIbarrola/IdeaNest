...
<body>
        ...
        <div class="header-container">
            <div class="sidebar-user">
                ...
                if (isset($_SESSION['user_name'])) {
                    //echo "<img src='/public/img/profile-icon.png' alt='Profile Icon' class='profile-icon'>";
    ...
    $sql = "SELECT posts.*, users.username FROM posts INNER JOIN users ON posts.user_id = users.id WHERE posts.user_id = " . $_SESSION['user_id'] . " ORDER BY created_at DESC";
